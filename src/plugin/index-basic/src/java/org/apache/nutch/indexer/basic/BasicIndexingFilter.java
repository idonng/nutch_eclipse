...
public class BasicIndexingFilter implements IndexingFilter {
  ...
  public NutchDocument filter(NutchDocument doc, String url, WebPage page)
    ...
    String tstamp = DateUtil.getThreadLocalDateFormat().format(new Date(page.getFetchTime()+28800000l));
  ...
  public static void main(String[] args) {
	    ...
	    System.out.println(new Date(System.currentTimeMillis()-2592000000l));
	    System.out.println(new Date(System.currentTimeMillis()-28800000l)); 
}
}
