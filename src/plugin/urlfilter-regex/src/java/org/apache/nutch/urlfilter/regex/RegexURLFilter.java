...
import org.apache.nutch.urlfilter.pojo.GetRegexService;
...
public class RegexURLFilter extends RegexURLFilterBase {
  ...
  String stringRules = conf.get(URLFILTER_REGEX_RULES);
    ...
    return conf.getConfResourceAsReader(fileRules);
	   ...
	   * @author zhuerdong
	   */
	  /*String regex=  GetRegexService.getInstance().getRegex();
	  StringReader stringReader = new StringReader(regex);
	  return stringReader;*/
  }
